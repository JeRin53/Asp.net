        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <asp:TextBox ID="TextBox3" runat="server" Placeholder="Enter Department name" Width="634px"></asp:TextBox>
                    ...
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Visible="False">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Department Photo">
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" runat="server" Height="174px" ImageUrl='<%# Eval("Doctor_photo") %>' Width="237px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
