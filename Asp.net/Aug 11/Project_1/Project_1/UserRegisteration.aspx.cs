...
namespace Project_1
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ins = "insert into User_tab values(" + reg_id + ",'" + TextBox1.Text + "'," + TextBox2.Text + ",'" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "',' ')";
            int i = obj1.Fn_ExecuteNonQuery(ins);
            if (i == 1)
            {
                string ins1 = "insert into Login_tab values(" + reg_id + ",'" + TextBox6.Text + "','" + TextBox8.Text + "','user')";
