<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DDLTest.aspx.cs" Inherits="UserRegistration.DDLTest" %>
...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Display Grid" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Display DataList" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td>
                    <asp:DataList ID="DataList1" runat="server" CssClass="auto-style3" RepeatColumns="3">
                        <ItemTemplate>
                            <table class="auto-style1">
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="Image1" runat="server" Height="159px" ImageUrl='<%# Eval("Photo") %>' Width="210px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
