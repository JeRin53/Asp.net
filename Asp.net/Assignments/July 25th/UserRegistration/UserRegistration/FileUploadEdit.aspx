<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUploadEdit.aspx.cs" Inherits="UserRegistration.FileUploadEdit" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Photo">
                                ...
                                <ItemTemplate>
                                    <asp:Image ID="Image1" runat="server" Height="240px" ImageUrl='<%# Eval("Photo") %>' Width="255px" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
