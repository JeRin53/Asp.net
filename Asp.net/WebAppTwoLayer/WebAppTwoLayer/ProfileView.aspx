<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfileView.aspx.cs" Inherits="WebAppTwoLayer.ProfileView" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>Photo</td>
                <td>
                    <asp:Image ID="Image1" runat="server" Height="409px" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                        ...
                        <ItemTemplate>
                            <table class="auto-style1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="Image2" runat="server" Height="114px" ImageUrl='<%# Eval("Photo") %>' Width="136px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
